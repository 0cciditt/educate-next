...
const slides: Slide[] = [
  {
    src: "/our-programs/card-3.webp",
    alt: "Niños jugando en el Summer Camp de Educate",
  },
  {
    src: "/summer-camp/hero-1.webp",
    alt: "Estudiantes en el Summer Camp de Educate",
  },
  {
...
export function SummerCampHero() {
  ...
  return (
    <section
      ...
      aria-label="Galería Summer Camp"
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(120,32,48,0.32) 0%, rgba(31,79,122,0.55) 100%)",
        }}
      />
      <div
        aria-hidden
        ...
        style={{
          background:
            "linear-gradient(95deg, rgba(31,79,122,0.7) 0%, rgba(120,32,48,0.45) 35%, rgba(120,32,48,0.1) 65%, transparent 85%)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12 xl:px-16 py-10 sm:py-12 md:py-14 lg:py-20 xl:py-24 min-h-[380px] sm:min-h-[420px] md:min-h-[460px] lg:min-h-[600px] xl:min-h-[660px] flex flex-col justify-center">
        <div className="max-w-[680px] text-center lg:text-left">
          ...
          >
            Summer Camp.{" "}
            <span className="text-yellow">El verano se vive aquí.</span>
          </h1>
          ...
          >
            Cuatro a seis semanas en Cali como Day Camp, o dos a cuatro
            semanas viviendo otra cultura en Canadá, Estados Unidos o
            Alemania. Lenguas, amistades y experiencias que no caben en un
            aula.
          </p>
