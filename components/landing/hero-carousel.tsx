...
export function HeroCarousel() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12 xl:px-16 py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 min-h-[540px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[720px] flex flex-col justify-center">
        <div className="max-w-[640px]">
          ...
          <h1
            className="font-display text-[40px] sm:text-5xl md:text-6xl lg:text-7xl xl:text-[84px] 2xl:text-[96px] leading-[0.92] tracking-[-0.025em] text-white"
