...
const rows: Row[] = [
  {
    ...
    body: "Entre diciembre y enero, niños y jóvenes desde los 10 años viajan a Canadá o Estados Unidos para vivir el inglés en su entorno natural. Días de nieve, deporte, cultura y nuevas amistades, con el idioma como herramienta real para conectar con el mundo.",
    bullets: [
    ...
    imageTone: "navy",
    image: "/winter-camp/card-1.webp",
    imageAlt:
      "Grupo de niños y jóvenes con esquís en la cima de una montaña nevada",
  },
  {
    eyebrow: "QUÉ SE VIVE",
    flip: true,
    ...
    body: "Cada Winter Camp combina aprendizaje, juego y descubrimiento. Lejos de casa y en otro idioma, los participantes desarrollan autonomía, liderazgo y habilidades blandas que los acompañan mucho después de regresar.",
    bullets: [
    ...
    imageTone: "orange",
    image: "/winter-camp/card-2.webp",
    imageAlt:
      "Dos niñas acariciando un caballo durante una actividad de invierno",
  },
];

export function WinterCampZigzag() {
  return (
