...
const rows: Row[] = [
  {
    ...
    body: "Durante la Semana Santa, niños y jóvenes viven un campamento diurno en Cali donde el inglés se aprende jugando. Cada tarde regresan a casa cargados de experiencias, vocabulario nuevo y amistades, sin necesidad de viajar.",
    bullets: [
      { label: "Duración", value: "5 días" },
      { label: "Modalidad", value: "Day Camp diurno" },
      { label: "Ciudad", value: "Cali, Valle del Cauca" },
      { label: "Temporada", value: "Semana Santa" },
    ],
  ...
  },
  {
    ...
    body: "Cinco días de juego, arte, deporte y descubrimiento con el inglés como hilo conductor. Una semana corta pero intensa donde los niños ganan confianza, hacen amigos y viven el idioma como una herramienta real.",
    bullets: [
...
export function SpringBreakCampZigzag() {
  return (
